...
public:
    UPROS_ARM()
    {
        ...
        single_joint_pub_ = n.advertise<zoo_bringup::SingleServo>("/single_servo_topic", 10);
        multiple_joint_pub_ = n.advertise<zoo_bringup::MultipleServo>("/multiple_servo_topic", 10);
